...
class ODQNAgent:
    ...
    def act(self, observation, prev_reward_list):
        """Select an action from the Q-network.

        Args:
            observation (np.array): The current state of the MRP.
            prev_reward_list (np.array): The previous reward list.
            ...
            if self.ggi_flag:
                ...
                for a_idx in range(self.data_mrp.num_actions):
                    ...
                    temp_var = (
                        ...
                        * q_values[
                            a_idx
                            * self.data_mrp.num_arms : (a_idx + 1)
                            * self.data_mrp.num_arms
                        ]
                    )
